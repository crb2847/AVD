...
init -1 python hide:
    ...
    config.window_title = u"Angelica Victorian Detective"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Angelica Victorian Detective"
    config.version = "0.2"
    ...
    style.default.font = "Fragmentcore.ttf"
...
python early:
    config.save_directory = "Angelica Victorian Detective-1443379226"
...
init python:
    ...
    build.directory_name = "AngelicaVictorianDetective-0.4"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Angelica Victorian Detective"
